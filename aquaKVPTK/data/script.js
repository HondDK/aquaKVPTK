...
function timer_time() {
	...
	//Ультрафиолет
	request5.open("GET", "/timer_time_lighting_purple_m_on", true);
	request6.open("GET", "/timer_time_lighting_purple_m_off", true);
	//Воздух растениям
	request7.open("GET", "/timer_air_m_on", true);
	request8.open("GET", "/timer_air_m_off", true);
	//Вода из аквариума к растениям
	request9.open("GET", "/timer_time_water_out_m_on", true);
